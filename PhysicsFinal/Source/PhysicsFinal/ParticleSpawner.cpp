...
{
	FVector particlePosition = GetPositionInBounds(GetActorLocation(), spawnVolume);
	AParticle* particle = GetWorld()->SpawnActor<AParticle>(particleToSpawn, particlePosition, GetActorRotation());
	if (particle != nullptr)
	{
